...
def process_invoice_with_llm(invoice_text: str, api_key: str):
    ...
    - **SupplierTaxNumber (NIT Proveedor):** Busca el NIT del emisor. 
    ...
    3. **EXTRACCIÓN DE ITEMS (Tabla de Productos):**
...
if __name__ == "__main__":
    ...
    ARCHIVO = "/home/olguin/Downloads/facturas/factura 221225_01.pdf"
